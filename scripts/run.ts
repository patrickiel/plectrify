 ...
 * --config <Debug|Release>. The release pipelines dispatch the same way, from
 * release.ts — see the note there on why announcing the step, rather than
 * making you name it, is what keeps a two-machine release legible.
 */
