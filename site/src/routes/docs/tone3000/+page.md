...
description: Browse the TONE3000 community library from inside Plectrify and load an amp capture as an ordinary patch — no files to find, unzip or point a plugin at.
---
...
position, the page you were on and how far down it you had scrolled — so closing it and coming back
...
capture here is the same plugin with the same six controls — the picture of the amp is the thing you
