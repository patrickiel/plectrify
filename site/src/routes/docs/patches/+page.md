...
- **Knob**: a continuous value such as gain, tone or mix.
- **Switch**: an on/off or a small set of positions such as bright, boost, cab on/off.
...
[Packages panel](/docs/packages), and they may carry their own assets, a capture or an impulse
