<script lang="ts">
  ...
  let { onOpen, namPluginId, onDragStart, onDragEnd }: Props = $props();
...
<button
  type="button"
  class={[
    'group flex min-w-0 items-center gap-2 rounded-lg border border-ink/25 bg-panel py-[.3rem] pr-3 pl-1.5 text-left transition-colors hover:border-accent/60 hover:bg-control-hover',
