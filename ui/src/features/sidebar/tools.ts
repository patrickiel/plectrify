...
export const UTILITY_TOOLS: readonly ToolDef[] = [
  // A shade wider than Settings: a row is a plugin's name over what it is for,
  // and that second line is a phrase ("Gate, compressor, EQ, delay and more")
  // rather than a setting's one-word label. Version, licence and project link
  // live behind the row's caret, so nothing else competes for the width.
  ...
  { id: 'plugins', label: 'Packages', icon: PackageIcon, width: '22rem', canMaximize: false },
