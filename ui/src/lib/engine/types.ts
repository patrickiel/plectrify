...
export interface RackModule {
  ...
  /** The TONE3000 tone this module is playing, when it came from one.
      ...
      It is also what *seals* the module: every tone here is the same plugin
      with the same six knobs, so the mapping is fixed and the plugin's own
      editor is not offered. See ModuleCard. */
